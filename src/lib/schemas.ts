...
export const birthFormSchema = z.object({
  ...
  faadhaar: z.string().length(12, 'Aadhaar must be 12 digits').optional().or(z.literal('')),
  mname: z.string().min(2, "Mother's name is required"),
  maadhaar: z.string().length(12, 'Aadhaar must be 12 digits').optional().or(z.literal('')),
